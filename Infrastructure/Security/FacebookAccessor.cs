...
namespace Infrastructure.Security
{
    public class FacebookAccessor : IFacebookAccessor
    {
        ...
        public async Task<FacebookUserIfo> FacebookLogin(string accessToken)
        {
            ...
            var result = await GetAsync<FacebookUserIfo>(accessToken, "me", "fields=name,email,picture.width(100).height(100)");
